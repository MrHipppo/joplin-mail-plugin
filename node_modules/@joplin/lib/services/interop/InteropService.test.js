...
describe('services_InteropService', () => {
    ...
    it('should export and import folders', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should import folders and de-duplicate titles when needed', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = InteropService_1.default.instance();
    ...
    it('should import folders, and only de-duplicate titles when needed', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = InteropService_1.default.instance();
    ...
    it('should export and import folders and notes', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = InteropService_1.default.instance();
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    it('should export and import notes to specific folder', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = InteropService_1.default.instance();
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
        let note1 = yield Note_1.default.save({ title: 'ma note', parent_id: folder1.id });
        note1 = yield Note_1.default.load(note1.id);
        ...
        expect(yield Note_1.default.count()).toBe(1);
        expect(yield Folder_1.default.count()).toBe(1);
        expect(yield (0, test_utils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield service.import({ path: filePath, destinationFolderId: 'oops' }); }))).toBe(true);
    })));
    it('should export and import tags', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = InteropService_1.default.instance();
        const filePath = `${(0, test_utils_1.exportDir)()}/test.jex`;
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    it('should export and import resources', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = InteropService_1.default.instance();
        const filePath = `${(0, test_utils_1.exportDir)()}/test.jex`;
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
        let note1 = yield Note_1.default.save({ title: 'ma note', parent_id: folder1.id });
    ...
    it('should export and import single notes', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = InteropService_1.default.instance();
        const filePath = `${(0, test_utils_1.exportDir)()}/test.jex`;
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
        const note1 = yield Note_1.default.save({ title: 'ma note', parent_id: folder1.id });
    ...
    it('should export and import single folders', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = InteropService_1.default.instance();
        const filePath = `${(0, test_utils_1.exportDir)()}/test.jex`;
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
        const note1 = yield Note_1.default.save({ title: 'ma note', parent_id: folder1.id });
    ...
    it('should export and import folder and its sub-folders', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = InteropService_1.default.instance();
        const filePath = `${(0, test_utils_1.exportDir)()}/test.jex`;
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    it('should export and import links to notes', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = InteropService_1.default.instance();
        const filePath = `${(0, test_utils_1.exportDir)()}/test.jex`;
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
        const note1 = yield Note_1.default.save({ title: 'ma note', parent_id: folder1.id });
    ...
    it('should export selected notes in md format', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = InteropService_1.default.instance();
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    it('should export MD with unicode filenames', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = InteropService_1.default.instance();
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    it('should export a notebook as MD', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should export conflict notes', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'testexportfolder' });
    ...
    it('should not try to export folders with a non-existing parent', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not export certain note properties', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should allow registering new import modules', (() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const module = (0, Module_1.makeImportModule)({
            ...
            return new InteropService_Importer_Custom_1.default({
                onExec: (context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should allow registering new export modules', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
        ...
        const module = (0, Module_1.makeExportModule)({
            ...
            return new InteropService_Exporter_Custom_1.default({
                onInit: (context) => __awaiter(void 0, void 0, void 0, function* () {
                    result.destPath = context.destPath;
                }),
                onProcessItem: (_context, itemType, item) => __awaiter(void 0, void 0, void 0, function* () {
                    result.itemTypes.push(itemType);
                    result.items.push(item);
                }),
                onProcessResource: (_context, resource, filePath) => __awaiter(void 0, void 0, void 0, function* () {
                    result.resources.push(resource);
                    result.filePaths.push(filePath);
                }),
                onClose: (_context) => __awaiter(void 0, void 0, void 0, function* () {
