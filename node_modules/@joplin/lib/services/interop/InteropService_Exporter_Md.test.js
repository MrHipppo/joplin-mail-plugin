...
describe('interop/InteropService_Exporter_Md', () => {
    ...
    it('should create resources directory', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should create note paths and add them to context', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should create resource paths and add them to context', (() => __awaiter(void 0, void 0, void 0, function* () {
        const exporter = new InteropService_Exporter_Md_1.default();
        yield exporter.init((0, test_utils_js_1.exportDir)());
        const itemsToExport = [];
        const queueExportItem = (itemType, itemOrId) => {
    ...
    it('should handle duplicate note names', (() => __awaiter(void 0, void 0, void 0, function* () {
        const exporter = new InteropService_Exporter_Md_1.default();
        yield exporter.init((0, test_utils_js_1.exportDir)());
        const itemsToExport = [];
        const queueExportItem = (itemType, itemOrId) => {
    ...
    it('should save resource files in _resource directory', (() => __awaiter(void 0, void 0, void 0, function* () {
        const exporter = new InteropService_Exporter_Md_1.default();
        yield exporter.init((0, test_utils_js_1.exportDir)());
        const itemsToExport = [];
        const queueExportItem = (itemType, itemOrId) => {
    ...
    it('should create folders in fs', (() => __awaiter(void 0, void 0, void 0, function* () {
        const exporter = new InteropService_Exporter_Md_1.default();
        yield exporter.init((0, test_utils_js_1.exportDir)());
        const itemsToExport = [];
        const queueExportItem = (itemType, itemOrId) => {
    ...
    it('should save notes in fs', (() => __awaiter(void 0, void 0, void 0, function* () {
        const exporter = new InteropService_Exporter_Md_1.default();
        yield exporter.init((0, test_utils_js_1.exportDir)());
        const itemsToExport = [];
        const queueExportItem = (itemType, itemOrId) => {
    ...
    it('should replace resource ids with relative paths', (() => __awaiter(void 0, void 0, void 0, function* () {
        const exporter = new InteropService_Exporter_Md_1.default();
        yield exporter.init((0, test_utils_js_1.exportDir)());
        const itemsToExport = [];
        const queueExportItem = (itemType, itemOrId) => {
    ...
    it('should replace note ids with relative paths', (() => __awaiter(void 0, void 0, void 0, function* () {
        const exporter = new InteropService_Exporter_Md_1.default();
        yield exporter.init((0, test_utils_js_1.exportDir)());
        const itemsToExport = [];
        const queueExportItem = (itemType, itemOrId) => {
        ...
        const changeNoteBodyAndReload = (note, newBody) => __awaiter(void 0, void 0, void 0, function* () {
            note.body = newBody;
    ...
    it('should url encode relative note links', (() => __awaiter(void 0, void 0, void 0, function* () {
        const exporter = new InteropService_Exporter_Md_1.default();
        yield exporter.init((0, test_utils_js_1.exportDir)());
        const itemsToExport = [];
        const queueExportItem = (itemType, itemOrId) => {
    ...
    it('should preserve resource file extension', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should url encode resource links', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder = yield Folder_1.default.save({ title: 'testing' });
        const note = yield Note_1.default.save({ title: 'mynote', parent_id: folder.id });
        yield shim_1.default.attachFileToNote(note, `${test_utils_js_1.supportDir}/photo.jpg`);
        const resource = (yield Resource_1.default.all())[0];
        yield Resource_1.default.save({ id: resource.id, title: 'name with spaces.jpg' });
        const service = InteropService_js_1.default.instance();
        yield service.export({
            path: (0, test_utils_js_1.exportDir)(),
            format: 'md',
        });
        const note_body = yield shim_1.default.fsDriver().readFile(`${(0, test_utils_js_1.exportDir)()}/testing/mynote.md`);
        expect(note_body).toContain('[photo.jpg](../_resources/name%20with%20spaces.jpg)');
    })));
    it('should handle filenames that contain slashes', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder = yield Folder_1.default.save({ title: 'testing' });
        const note = yield Note_1.default.save({ title: 'mynote', parent_id: folder.id });
        yield shim_1.default.attachFileToNote(note, `${test_utils_js_1.supportDir}/photo.jpg`);
        const resource = (yield Resource_1.default.all())[0];
        yield Resource_1.default.save({ id: resource.id, filename: 'a/b/c/test.jpg', title: 'name with spaces.jpg' });
        const service = InteropService_js_1.default.instance();
        yield service.export({
            path: (0, test_utils_js_1.exportDir)(),
            format: 'md',
        });
        const files = yield (0, promises_1.readdir)(`${(0, test_utils_js_1.exportDir)()}/_resources`);
