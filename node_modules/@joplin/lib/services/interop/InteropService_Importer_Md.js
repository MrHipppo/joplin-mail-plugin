    ...
    exec(result) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const importedLocalPath of Object.keys(this.importedNotes)) {
                ...
                const updatedBody = yield this.importLocalFiles(importedLocalPath, note.body, note.parent_id);
                const updatedNote = Object.assign(Object.assign({}, this.importedNotes[importedLocalPath]), { body: updatedBody || note.body });
                this.importedNotes[importedLocalPath] = yield Note_1.default.save(updatedNote, { isNew: false, autoTimestamp: false });
            }
            return result;
        });
    }
