...
describe('interop/InteropService_Exporter_Md_frontmatter', () => {
    ...
    test('should export MD file with YAML header', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('should export without additional quotes', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    test('should export tags', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    test('should export todo', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    test('should export author', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    test('should export source', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    test('should export fields in the correct order', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    test('should export title with a newline encoded', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    test('should not export coordinates if they\'re not available', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    test('should export note without tag keyword if the tag has been deleted', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
        const note = yield Note_1.default.save({ title: 'NoTag', body: '**ma note**', parent_id: folder1.id });
        const tag = yield Tag_1.default.save({ title: 'tag' });
        yield Tag_1.default.setNoteTagsByIds(note.id, [tag.id]);
        yield Tag_1.default.delete(tag.id);
        const content = yield exportAndLoad(`${(0, test_utils_1.exportDir)()}/folder1/NoTag.md`);
