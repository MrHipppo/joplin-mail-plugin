...
describe('services_CommandService', () => {
    ...
    it('should create toolbar button infos from commands', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should enable and disable toolbar buttons depending on state', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = newService();
        const toolbarButtonUtils = new ToolbarButtonUtils_1.default(service);
        registerCommand(service, createCommand('test1', {
            execute: () => { },
    ...
    it('should enable commands by default', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = newService();
        registerCommand(service, createCommand('test1', {
            execute: () => { },
        }));
    ...
    it('should return the same toolbarButtons array if nothing has changed', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = newService();
        const toolbarButtonUtils = new ToolbarButtonUtils_1.default(service);
        registerCommand(service, createCommand('test1', {
            execute: () => { },
    ...
    it('should create menu items from commands', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = newService();
    ...
    it('should give menu item props from state', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = newService();
        const utils = new MenuUtils_1.default(service);
        registerCommand(service, createCommand('test1', {
            execute: () => { },
    ...
    it('should create stateful menu items', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = newService();
        const utils = new MenuUtils_1.default(service);
        let propValue = null;
        registerCommand(service, createCommand('test1', {
    ...
    it('should throw an error for invalid when clause keys in dev mode', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = newService();
        registerCommand(service, createCommand('test1', {
            execute: () => { },
            enabledCondition: 'cond1 && cond2',
        }));
        yield (0, test_utils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return service.isEnabled('test1', {}); }));
        yield (0, test_utils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return service.isEnabled('test1', { cond1: true }); }));
        yield (0, test_utils_1.expectNotThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return service.isEnabled('test1', { cond1: true, cond2: true }); }));
        yield (0, test_utils_1.expectNotThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return service.isEnabled('test1', { cond1: true, cond2: false }); }));
    })));
