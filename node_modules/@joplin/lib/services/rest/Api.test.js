...
describe('services_rest_Api', () => {
    ...
    it('should ping', (() => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield api.route(Api_1.RequestMethod.GET, 'ping');
        expect(response).toBe('JoplinClipperServer');
    })));
    it('should handle Not Found errors', (() => __awaiter(void 0, void 0, void 0, function* () {
        const hasThrown = yield (0, test_utils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield api.route(Api_1.RequestMethod.GET, 'pong'); }));
        expect(hasThrown).toBe(true);
    })));
    it('should get folders', (() => __awaiter(void 0, void 0, void 0, function* () {
        yield Folder_1.default.save({ title: 'mon carnet' });
        const response = yield api.route(Api_1.RequestMethod.GET, 'folders');
        expect(response.items.length).toBe(1);
    })));
    it('should update folders', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should delete folders', (() => __awaiter(void 0, void 0, void 0, function* () {
        const f1 = yield Folder_1.default.save({ title: 'mon carnet' });
        yield api.route(Api_1.RequestMethod.DELETE, `folders/${f1.id}`);
        const f1b = yield Folder_1.default.load(f1.id);
        expect(!f1b).toBe(true);
    })));
    it('should create folders', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should get one folder', (() => __awaiter(void 0, void 0, void 0, function* () {
        const f1 = yield Folder_1.default.save({ title: 'mon carnet' });
        const response = yield api.route(Api_1.RequestMethod.GET, `folders/${f1.id}`);
        expect(response.id).toBe(f1.id);
        const hasThrown = yield (0, test_utils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield api.route(Api_1.RequestMethod.GET, 'folders/doesntexist'); }));
        expect(hasThrown).toBe(true);
    })));
    it('should get the folder notes', (() => __awaiter(void 0, void 0, void 0, function* () {
        const f1 = yield Folder_1.default.save({ title: 'mon carnet' });
    ...
    it('should fail on invalid paths', (() => __awaiter(void 0, void 0, void 0, function* () {
        const hasThrown = yield (0, test_utils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield api.route(Api_1.RequestMethod.GET, 'schtroumpf'); }));
        expect(hasThrown).toBe(true);
    })));
    it('should get notes', (() => __awaiter(void 0, void 0, void 0, function* () {
        let response = null;
        const f1 = yield Folder_1.default.save({ title: 'mon carnet' });
    ...
    it('should create notes', (() => __awaiter(void 0, void 0, void 0, function* () {
        let response = null;
    ...
    it('should allow setting note properties', (() => __awaiter(void 0, void 0, void 0, function* () {
        let response = null;
        const f = yield Folder_1.default.save({ title: 'mon carnet' });
        response = yield api.route(Api_1.RequestMethod.POST, 'notes', null, JSON.stringify({
            title: 'testing',
    ...
    it('should preserve user timestamps when creating notes', (() => __awaiter(void 0, void 0, void 0, function* () {
        let response = null;
        const f = yield Folder_1.default.save({ title: 'mon carnet' });
    ...
    it('should preserve user timestamps when updating notes', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should create notes with supplied ID', (() => __awaiter(void 0, void 0, void 0, function* () {
        let response = null;
        const f = yield Folder_1.default.save({ title: 'mon carnet' });
        response = yield api.route(Api_1.RequestMethod.POST, 'notes', null, JSON.stringify({
    ...
    it('should create todos', (() => __awaiter(void 0, void 0, void 0, function* () {
        let response = null;
    ...
    it('should create folders with supplied ID', (() => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield api.route(Api_1.RequestMethod.POST, 'folders', null, JSON.stringify({
            id: '12345678123456781234567812345678',
            title: 'from api',
        }));
    ...
    it('should create notes with images', (() => __awaiter(void 0, void 0, void 0, function* () {
        let response = null;
        const f = yield Folder_1.default.save({ title: 'mon carnet' });
        response = yield api.route(Api_1.RequestMethod.POST, 'notes', null, JSON.stringify({
            title: 'testing image',
    ...
    it('should not compress images uploaded through resource API', (() => __awaiter(void 0, void 0, void 0, function* () {
        const originalImagePath = `${test_utils_1.supportDir}/photo-large.png`;
    ...
    it('should update a resource', (() => __awaiter(void 0, void 0, void 0, function* () {
        yield api.route(Api_1.RequestMethod.POST, 'resources', null, JSON.stringify({
            title: 'resource',
        }), [
            {
                path: `${test_utils_1.supportDir}/photo.jpg`,
            },
        ]);
        const resourceV1 = (yield Resource_1.default.all())[0];
        yield (0, test_utils_1.msleep)(1);
        yield api.route(Api_1.RequestMethod.PUT, `resources/${resourceV1.id}`, null, JSON.stringify({
            title: 'resource mod',
        }), [
            {
                path: `${test_utils_1.supportDir}/photo-large.png`,
            },
        ]);
        const resourceV2 = (yield Resource_1.default.all())[0];
        ...
        expect(resourceV2.size).toBe((yield shim_1.default.fsDriver().stat(Resource_1.default.fullPath(resourceV2))).size);
    })));
    it('should allow updating a resource file only', (() => __awaiter(void 0, void 0, void 0, function* () {
        yield api.route(Api_1.RequestMethod.POST, 'resources', null, JSON.stringify({
            title: 'resource',
        }), [{ path: `${test_utils_1.supportDir}/photo.jpg` }]);
        const resourceV1 = (yield Resource_1.default.all())[0];
        yield (0, test_utils_1.msleep)(1);
        yield api.route(Api_1.RequestMethod.PUT, `resources/${resourceV1.id}`, null, null, [
            {
                path: `${test_utils_1.supportDir}/photo-large.png`,
            },
        ]);
    ...
    it('should update resource properties', (() => __awaiter(void 0, void 0, void 0, function* () {
        yield api.route(Api_1.RequestMethod.POST, 'resources', null, JSON.stringify({
            title: 'resource',
        }), [{ path: `${test_utils_1.supportDir}/photo.jpg` }]);
        const resourceV1 = (yield Resource_1.default.all())[0];
    ...
    it('should delete resources', (() => __awaiter(void 0, void 0, void 0, function* () {
        const f = yield Folder_1.default.save({ title: 'mon carnet' });
    ...
    it('should create notes from HTML', (() => __awaiter(void 0, void 0, void 0, function* () {
        let response = null;
        const f = yield Folder_1.default.save({ title: 'mon carnet' });
        response = yield api.route(Api_1.RequestMethod.POST, 'notes', null, JSON.stringify({
            title: 'testing HTML',
    ...
    it('should extract media urls from body', (() => {
        ...
        tests.forEach((test) => {
            const urls = (0, notes_1.extractMediaUrls)(test.language, test.body);
            expect(urls).toEqual(test.result);
        });
    }));
    it('should create notes with pdf embeds', (() => __awaiter(void 0, void 0, void 0, function* () {
        let response = null;
        const f = yield Folder_1.default.save({ title: 'pdf test1' });
        response = yield api.route(Api_1.RequestMethod.POST, 'notes', null, JSON.stringify({
            title: 'testing PDF embeds',
            parent_id: f.id,
            body_html: `<div> <embed src="file://${test_utils_1.supportDir}/welcome.pdf" type="application/pdf" /> </div>`,
        }));
        const resources = yield Resource_1.default.all();
        expect(resources.length).toBe(1);
        const resource = resources[0];
    ...
    it('should handle tokens', (() => __awaiter(void 0, void 0, void 0, function* () {
        api = new Api_1.default('mytoken');
        let hasThrown = yield (0, test_utils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield api.route(Api_1.RequestMethod.GET, 'notes'); }));
        expect(hasThrown).toBe(true);
        const response = yield api.route(Api_1.RequestMethod.GET, 'notes', { token: 'mytoken' });
        expect(response.items.length).toBe(0);
        hasThrown = yield (0, test_utils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield api.route(Api_1.RequestMethod.POST, 'notes', null, JSON.stringify({ title: 'testing' })); }));
        expect(hasThrown).toBe(true);
    })));
    it('should add tags to notes', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should remove tags from notes', (() => __awaiter(void 0, void 0, void 0, function* () {
        const tag = yield Tag_1.default.save({ title: 'mon étiquette' });
        const note = yield Note_1.default.save({ title: 'ma note' });
    ...
    it('should list all tag notes', (() => __awaiter(void 0, void 0, void 0, function* () {
        const tag = yield Tag_1.default.save({ title: 'mon étiquette' });
    ...
    it('should update tags when updating notes', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should create and update tags when updating notes', (() => __awaiter(void 0, void 0, void 0, function* () {
        const tag1 = yield Tag_1.default.save({ title: 'mon étiquette 1' });
        const tag2 = yield Tag_1.default.save({ title: 'mon étiquette 2' });
    ...
    it('should not update tags if tags is not mentioned when updating', (() => __awaiter(void 0, void 0, void 0, function* () {
        const tag1 = yield Tag_1.default.save({ title: 'mon étiquette 1' });
        const tag2 = yield Tag_1.default.save({ title: 'mon étiquette 2' });
        const note = yield Note_1.default.save({
            title: 'ma note un',
    ...
    it('should remove tags from note if tags is set to empty string when updating', (() => __awaiter(void 0, void 0, void 0, function* () {
        const tag1 = yield Tag_1.default.save({ title: 'mon étiquette 1' });
        const tag2 = yield Tag_1.default.save({ title: 'mon étiquette 2' });
        const note = yield Note_1.default.save({
            title: 'ma note un',
    ...
    it('should paginate results and handle duplicate field values', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should paginate results and return the requested fields only', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should paginate folder notes', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should sort search paginated results', (() => __awaiter(void 0, void 0, void 0, function* () {
        SearchEngine_1.default.instance().setDb((0, test_utils_1.db)());
    ...
    it('should return default fields', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should return the notes associated with a resource', (() => __awaiter(void 0, void 0, void 0, function* () {
        const note = yield Note_1.default.save({});
    ...
    it('should return the resources associated with a note', (() => __awaiter(void 0, void 0, void 0, function* () {
        const note = yield Note_1.default.save({});
        yield shim_1.default.attachFileToNote(note, `${test_utils_1.supportDir}/photo.jpg`);
        const resource = (yield Resource_1.default.all())[0];
