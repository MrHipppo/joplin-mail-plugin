...
describe('routes/events', () => {
    ...
    it('should retrieve the latest events', () => __awaiter(void 0, void 0, void 0, function* () {
        let cursor = '0';
        {
    ...
    it('should limit the number of response items', () => __awaiter(void 0, void 0, void 0, function* () {
        const promises = [];
        for (let i = 0; i < 101; i++) {
    ...
    it('should retrieve a single item', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, test_utils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return api.route(Api_1.RequestMethod.GET, 'events/1234'); }));
    }));
});
