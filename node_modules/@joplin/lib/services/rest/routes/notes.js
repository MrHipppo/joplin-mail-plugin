...
exports.extractNoteFromHTML = exports.extractMediaUrls = exports.downloadMediaFile = void 0;
...
const extractNoteFromHTML = (requestNote, requestId, imageSizes) => __awaiter(void 0, void 0, void 0, function* () {
    const note = yield requestNoteToNote(requestNote);
    ...
    const mediaFiles = yield downloadMediaFiles(mediaUrls); // , allowFileProtocolImages);
    logger.info(`Request (${requestId}): Creating resources from paths: ${Object.getOwnPropertyNames(mediaFiles).length}`);
    const resources = yield createResourcesFromPaths(mediaFiles);
    yield removeTempFiles(resources);
...
function default_1(request, id = null, link = null) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (request.method === Api_1.RequestMethod.POST) {
            ...
            const extracted = yield (0, exports.extractNoteFromHTML)(requestNote, requestId, imageSizes);
            let note = yield Note_1.default.save(extracted.note, extracted.saveOptions);
            if (requestNote.tags) {
