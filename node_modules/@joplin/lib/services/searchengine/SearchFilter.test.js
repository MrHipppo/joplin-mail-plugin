...
describe('services_SearchFilter', () => {
    ...
    it('should ignore dashes in a word', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const searchType of [SearchEngine_1.default.SEARCH_TYPE_FTS, SearchEngine_1.default.SEARCH_TYPE_NONLATIN_SCRIPT]) {
        describe(`search type ${searchType}`, () => {
            it('check case insensitivity for filter keywords', (() => __awaiter(void 0, void 0, void 0, function* () {
                let rows;
            ...
            it('should return note matching title', (() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should return note matching negated title', (() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should return note matching body', (() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should return note matching negated body', (() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should return note matching title containing multiple words', (() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should return note matching body containing multiple words', (() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should return note matching title AND body', (() => __awaiter(void 0, void 0, void 0, function* () {
                let rows;
                yield Note_1.default.save({ title: 'abcd', body: 'ho ho ho' });
                const n2 = yield Note_1.default.save({ title: 'efgh', body: 'foo bar' });
                yield engine.syncTables();
            ...
            it('should return note matching title OR body', (() => __awaiter(void 0, void 0, void 0, function* () {
                let rows;
            ...
            it('should return notes matching text', (() => __awaiter(void 0, void 0, void 0, function* () {
                let rows;
            ...
            it('should return notes matching any negated text', (() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should return notes matching any negated title', (() => __awaiter(void 0, void 0, void 0, function* () {
                const n1 = yield Note_1.default.save({ title: 'abc', body: 'def' });
                const n2 = yield Note_1.default.save({ title: 'def', body: 'ghi' });
                const n3 = yield Note_1.default.save({ title: 'ghi', body: 'jkl' });
                yield engine.syncTables();
            ...
            it('should return notes matching any negated body', (() => __awaiter(void 0, void 0, void 0, function* () {
                const n1 = yield Note_1.default.save({ title: 'abc', body: 'def' });
                const n2 = yield Note_1.default.save({ title: 'def', body: 'ghi' });
                const n3 = yield Note_1.default.save({ title: 'ghi', body: 'jkl' });
                yield engine.syncTables();
            ...
            it('should support phrase search', (() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should support prefix search', (() => __awaiter(void 0, void 0, void 0, function* () {
                const n1 = yield Note_1.default.save({ title: 'foo beef', body: 'bar dog' });
                const n2 = yield Note_1.default.save({ title: 'bar efgh', body: 'foo dog' });
                yield engine.syncTables();
            ...
            it('should support filtering by tags', (() => __awaiter(void 0, void 0, void 0, function* () {
                let rows;
            ...
            it('should support filtering by tags (2)', (() => __awaiter(void 0, void 0, void 0, function* () {
                let rows;
            ...
            it('should support filtering by notebook', (() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should support filtering by nested notebook', (() => __awaiter(void 0, void 0, void 0, function* () {
                const folder0 = yield Folder_1.default.save({ title: 'notebook0' });
            ...
            it('should support filtering by multiple notebooks', (() => __awaiter(void 0, void 0, void 0, function* () {
                const folder0 = yield Folder_1.default.save({ title: 'notebook0' });
                const folder00 = yield Folder_1.default.save({ title: 'notebook00', parent_id: folder0.id });
                const folder1 = yield Folder_1.default.save({ title: 'notebook1' });
            ...
            it('should support filtering and search term', (() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should support filtering by created date', (() => __awaiter(void 0, void 0, void 0, function* () {
                let rows;
                const n1 = yield Note_1.default.save({ title: 'I made this on', body: 'May 20 2020', user_created_time: dateStringToTimestamp('2020-05-20') });
                const n2 = yield Note_1.default.save({ title: 'I made this on', body: 'May 19 2020', user_created_time: dateStringToTimestamp('2020-05-19') });
                const n3 = yield Note_1.default.save({ title: 'I made this on', body: 'May 18 2020', user_created_time: dateStringToTimestamp('2020-05-18') });
                yield engine.syncTables();
            ...
            it('should support filtering by between two dates', (() => __awaiter(void 0, void 0, void 0, function* () {
                let rows;
                const n1 = yield Note_1.default.save({ title: 'January 01 2020', body: 'January 01 2020', user_created_time: dateStringToTimestamp('2020-01-01') });
                const n2 = yield Note_1.default.save({ title: 'February 15 2020', body: 'February 15 2020', user_created_time: dateStringToTimestamp('2020-02-15') });
                const n3 = yield Note_1.default.save({ title: 'March 25 2019', body: 'March 25 2019', user_created_time: dateStringToTimestamp('2019-03-25') });
                const n4 = yield Note_1.default.save({ title: 'March 01 2018', body: 'March 01 2018', user_created_time: dateStringToTimestamp('2018-03-01') });
                yield engine.syncTables();
            ...
            it('should support filtering by created with smart value: day', (() => __awaiter(void 0, void 0, void 0, function* () {
                let rows;
            ...
            it('should support filtering by created with smart value: week', (() => __awaiter(void 0, void 0, void 0, function* () {
                let rows;
            ...
            it('should support filtering by created with smart value: month', (() => __awaiter(void 0, void 0, void 0, function* () {
                let rows;
            ...
            it('should support filtering by created with smart value: year', (() => __awaiter(void 0, void 0, void 0, function* () {
                let rows;
            ...
            it('should support filtering by updated date', (() => __awaiter(void 0, void 0, void 0, function* () {
                let rows;
                const n1 = yield Note_1.default.save({ title: 'I updated this on', body: 'May 20 2020', updated_time: dateStringToTimestamp('2020-05-20'), user_updated_time: dateStringToTimestamp('2020-05-20') }, { autoTimestamp: false });
                const n2 = yield Note_1.default.save({ title: 'I updated this on', body: 'May 19 2020', updated_time: dateStringToTimestamp('2020-05-19'), user_updated_time: dateStringToTimestamp('2020-05-19') }, { autoTimestamp: false });
                yield engine.syncTables();
            ...
            it('should support filtering by updated with smart value: day', (() => __awaiter(void 0, void 0, void 0, function* () {
                let rows;
            ...
            it('should support filtering by type todo', (() => __awaiter(void 0, void 0, void 0, function* () {
                let rows;
            ...
            it('should support filtering by type note', (() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should support filtering by due date', (() => __awaiter(void 0, void 0, void 0, function* () {
                let rows;
                const toDo1 = yield Note_1.default.save({ title: 'ToDo 1', body: 'todo', is_todo: 1, todo_due: dateStringToTimestamp('2021-04-27') });
                const toDo2 = yield Note_1.default.save({ title: 'ToDo 2', body: 'todo', is_todo: 1, todo_due: dateStringToTimestamp('2021-03-17') });
            ...
            it('should support filtering by due with smart value: day', (() => __awaiter(void 0, void 0, void 0, function* () {
                let rows;
            ...
            it('should support filtering by latitude, longitude, altitude', (() => __awaiter(void 0, void 0, void 0, function* () {
                let rows;
            ...
            it('should support filtering by resource MIME type', (() => __awaiter(void 0, void 0, void 0, function* () {
                let rows;
            ...
            it('should support filtering by sourceurl', (() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should support negating notebooks', (() => __awaiter(void 0, void 0, void 0, function* () {
                const folder1 = yield Folder_1.default.save({ title: 'folder1' });
            ...
            it('should support both inclusion and exclusion of notebooks together', (() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should support filtering by note id', (() => __awaiter(void 0, void 0, void 0, function* () {
                let rows;
