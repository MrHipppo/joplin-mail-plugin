...
describe('services_SearchEngineUtils', () => {
    ...
    describe('filter todos based on showCompletedTodos', () => {
        it('show completed', (() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('hide completed', (() => __awaiter(void 0, void 0, void 0, function* () {
            const note1 = yield Note.save({ title: 'abcd', body: 'body 1' });
            const todo1 = yield Note.save({ title: 'abcd', body: 'todo 1', is_todo: 1 });
            yield Note.save({ title: 'qwer', body: 'body 2' });
        ...
        it('show completed (!applyUserSettings)', (() => __awaiter(void 0, void 0, void 0, function* () {
            const note1 = yield Note.save({ title: 'abcd', body: 'body 1' });
            const todo1 = yield Note.save({ title: 'abcd', body: 'todo 1', is_todo: 1 });
            yield Note.save({ title: 'qwer', body: 'body 2' });
            const todo2 = yield Note.save({ title: 'abcd', body: 'todo 2', is_todo: 1, todo_completed: 1590085027710 });
    ...
    it('remove auto added fields', (() => __awaiter(void 0, void 0, void 0, function* () {
