...
describe('services/RevisionService', () => {
    ...
    it('should create diff and rebuild notes', (() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, test_utils_1.msleep)(10);
    ...
    // }));
    it('should delete old revisions (1 note, 2 rev)', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = new RevisionService_1.default();
    ...
    it('should delete old revisions (1 note, 3 rev)', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = new RevisionService_1.default();
        const n1_v0 = yield Note_1.default.save({ title: '' });
    ...
    it('should delete old revisions (2 notes, 2 rev)', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = new RevisionService_1.default();
        const n1_v0 = yield Note_1.default.save({ title: '' });
    ...
    it('should handle conflicts', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = new RevisionService_1.default();
    ...
    it('should create a revision for notes that are older than a given interval', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should create a revision for notes that get deleted (recyle bin)', (() => __awaiter(void 0, void 0, void 0, function* () {
        const n1 = yield Note_1.default.save({ title: 'hello' });
        const noteId = n1.id;
    ...
    it('should not create a revision for notes that get deleted if there is already a revision', (() => __awaiter(void 0, void 0, void 0, function* () {
        const n1 = yield Note_1.default.save({ title: 'hello' });
        yield (0, test_utils_1.revisionService)().collectRevisions();
        const noteId = n1.id;
    ...
    it('should not create a revision for new note the first time they are saved', (() => __awaiter(void 0, void 0, void 0, function* () {
        const n1 = yield Note_1.default.save({ title: 'hello' });
        {
    ...
    it('should abort collecting revisions when one of them is encrypted', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not delete old revisions if one of them is still encrypted (1)', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not delete old revisions if one of them is still encrypted (2)', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not delete old revisions if one of them is still encrypted (3)', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not create a revision if the note has not changed', (() => __awaiter(void 0, void 0, void 0, function* () {
        const n1_v0 = yield Note_1.default.save({ title: '' });
    ...
    it('should preserve user update time', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not create a revision if there is already a recent one', (() => __awaiter(void 0, void 0, void 0, function* () {
        const n1_v0 = yield Note_1.default.save({ title: '' });
        yield Note_1.default.save({ id: n1_v0.id, title: 'hello' });
        yield (0, test_utils_1.revisionService)().collectRevisions(); // REV 1
        const timeRev1 = Date.now();
        yield (0, test_utils_1.msleep)(200);
    ...
    it('should give a detailed error when a patch cannot be applied', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('note revisions should include certain required properties', () => __awaiter(void 0, void 0, void 0, function* () {
        const revisions = [
            {
