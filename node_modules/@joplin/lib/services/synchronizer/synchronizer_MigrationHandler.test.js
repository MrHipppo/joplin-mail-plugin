...
describe('MigrationHandler', () => {
    ...
    it('should init a new sync target', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not allow syncing if the sync target is out-dated', (() => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, test_utils_1.synchronizer)().start();
        yield (0, test_utils_1.fileApi)().put('info.json', `{"version":${Setting_1.default.value('syncVersion') - 1}}`);
        yield (0, test_utils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return yield migrationHandler().checkCanSync(); }), 'outdatedSyncTarget');
    })), specTimeout);
    it('should not allow syncing if the client is out-dated', (() => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, test_utils_1.synchronizer)().start();
        yield (0, test_utils_1.fileApi)().put('info.json', `{"version":${Setting_1.default.value('syncVersion') + 1}}`);
        yield (0, test_utils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return yield migrationHandler().checkCanSync(); }), 'outdatedClient');
    })), specTimeout);
    it('should apply migration 2 normal', () => __awaiter(void 0, void 0, void 0, function* () {
        yield testMigration(2, maxSyncVersion);
    }), specTimeout);
    it('should apply migration 2 E2EE', () => __awaiter(void 0, void 0, void 0, function* () {
        yield testMigrationE2EE(2, maxSyncVersion);
    }), specTimeout);
    it('should apply migration 3 normal', () => __awaiter(void 0, void 0, void 0, function* () {
        yield testMigration(3, maxSyncVersion);
    }), specTimeout);
    it('should apply migration 3 E2EE', () => __awaiter(void 0, void 0, void 0, function* () {
