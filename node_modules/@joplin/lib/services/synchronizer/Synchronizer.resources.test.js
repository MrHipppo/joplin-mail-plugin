...
describe('Synchronizer.resources', () => {
    ...
    it('should sync resources', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should handle resource download errors', () => __awaiter(void 0, void 0, void 0, function* () {
        while (insideBeforeEach)
            yield time_1.default.msleep(500);
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
        const note1 = yield Note_1.default.save({ title: 'ma note', parent_id: folder1.id });
    ...
    it('should set the resource file size if it is missing', () => __awaiter(void 0, void 0, void 0, function* () {
        while (insideBeforeEach)
            yield time_1.default.msleep(500);
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
        const note1 = yield Note_1.default.save({ title: 'ma note', parent_id: folder1.id });
    ...
    it('should encrypt resources', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should sync resource blob changes', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should handle resource conflicts', () => __awaiter(void 0, void 0, void 0, function* () {
        {
            const tempFile = (0, test_utils_1.tempFilePath)('txt');
            yield shim_1.default.fsDriver().writeFile(tempFile, '1234', 'utf8');
            const folder1 = yield Folder_1.default.save({ title: 'folder1' });
        ...
        yield (0, test_utils_1.switchClient)(1);
        {
            ...
            yield (0, test_utils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield Resource_1.default.resourceBlobContent(resource.id); }));
    ...
    it('should handle resource conflicts if a resource is changed locally but deleted remotely', () => __awaiter(void 0, void 0, void 0, function* () {
        {
            const tempFile = (0, test_utils_1.tempFilePath)('txt');
            yield shim_1.default.fsDriver().writeFile(tempFile, '1234', 'utf8');
            const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    it('should not upload a resource if it has not been fetched yet', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not download resources over the limit', () => __awaiter(void 0, void 0, void 0, function* () {
        const note1 = yield Note_1.default.save({ title: 'note' });
        yield shim_1.default.attachFileToNote(note1, `${test_utils_1.supportDir}/photo.jpg`);
    ...
    it('should not upload blob if it has not changed', () => __awaiter(void 0, void 0, void 0, function* () {
        const note = yield Note_1.default.save({});
        yield shim_1.default.attachFileToNote(note, `${test_utils_1.supportDir}/sample.txt`);
        const resource = (yield Resource_1.default.all())[0];
        const resourcePath = `.resource/${resource.id}`;
        yield (0, test_utils_1.synchronizer)().api().put(resourcePath, 'before upload');
        expect(yield (0, test_utils_1.synchronizer)().api().get(resourcePath)).toBe('before upload');
        yield (0, test_utils_1.synchronizerStart)();
        expect(yield (0, test_utils_1.synchronizer)().api().get(resourcePath)).toBe('just testing');
        // ----------------------------------------------------------------------
        ...
        // should remain.
        // ----------------------------------------------------------------------
        yield Resource_1.default.save({ id: resource.id, title: 'my new title' });
        yield (0, test_utils_1.synchronizer)().api().put(resourcePath, 'check if changed');
        yield (0, test_utils_1.synchronizerStart)();
        expect(yield (0, test_utils_1.synchronizer)().api().get(resourcePath)).toBe('check if changed');
        // ----------------------------------------------------------------------
        // Now change the blob, and check that the remote item has been
        // overwritten.
        // ----------------------------------------------------------------------
        yield Resource_1.default.updateResourceBlobContent(resource.id, `${test_utils_1.supportDir}/sample.txt`);
        yield (0, test_utils_1.synchronizerStart)();
        expect(yield (0, test_utils_1.synchronizer)().api().get(resourcePath)).toBe('just testing');
        // ----------------------------------------------------------------------
        ...
        // the item sync_time.
        // ----------------------------------------------------------------------
        yield Resource_1.default.updateResourceBlobContent(resource.id, `${test_utils_1.supportDir}/sample2.txt`);
        yield (0, test_utils_1.msleep)(1);
        yield Resource_1.default.save({ id: resource.id, title: 'my new title 2' });
        yield (0, test_utils_1.synchronizerStart)();
        expect(yield (0, test_utils_1.synchronizer)().api().get(resourcePath)).toBe('just testing 2');
        expect(yield (0, test_utils_1.synchronizer)().api().get(`${resource.id}.md`)).toContain('my new title 2');
    }));
});
