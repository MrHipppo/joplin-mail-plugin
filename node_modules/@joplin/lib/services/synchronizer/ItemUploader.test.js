...
describe('synchronizer/ItemUploader', () => {
    ...
    it('should batch uploads and use the cache afterwards', (() => __awaiter(void 0, void 0, void 0, function* () {
        const callRecorder = [];
    ...
    it('should not batch upload if the items are over the batch size limit', (() => __awaiter(void 0, void 0, void 0, function* () {
        const callRecorder = [];
        const itemUploader = new ItemUploader_1.default(newFakeApi(), newFakeApiCall(callRecorder));
    ...
    it('should not use the cache if the note has changed since the pre-upload', (() => __awaiter(void 0, void 0, void 0, function* () {
        const callRecorder = [];
        const itemUploader = new ItemUploader_1.default(newFakeApi(), newFakeApiCall(callRecorder));
        const notes = [
            yield Note_1.default.save({ title: '1' }),
    ...
    it('should respect the max batch size', (() => __awaiter(void 0, void 0, void 0, function* () {
        const callRecorder = [];
        const itemUploader = new ItemUploader_1.default(newFakeApi(), newFakeApiCall(callRecorder));
        const notes = [
            yield Note_1.default.save({ title: '1' }),
    ...
    it('should rethrow error for items within the batch', (() => __awaiter(void 0, void 0, void 0, function* () {
        const callRecorder = [];
        const notes = [
            yield Note_1.default.save({ title: '1' }),
            yield Note_1.default.save({ title: '2' }),
        ...
        yield itemUploader.preUploadItems(notes);
        yield (0, test_utils_1.expectNotThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return itemUploader.serializeAndUploadItem(Note_1.default, BaseItem_1.default.systemPath(notes[0]), notes[0]); }));
        yield (0, test_utils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return itemUploader.serializeAndUploadItem(Note_1.default, BaseItem_1.default.systemPath(notes[1]), notes[1]); }), null);
        yield (0, test_utils_1.expectNotThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return itemUploader.serializeAndUploadItem(Note_1.default, BaseItem_1.default.systemPath(notes[2]), notes[2]); }));
    })));
});
