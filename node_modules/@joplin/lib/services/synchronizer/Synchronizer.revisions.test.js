...
describe('Synchronizer.revisions', () => {
    ...
    it('should not save revisions when updating a note via sync', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not save revisions when deleting a note via sync', (() => __awaiter(void 0, void 0, void 0, function* () {
        const n1 = yield Note_1.default.save({ title: 'testing' });
        yield (0, test_utils_1.synchronizerStart)();
        yield (0, test_utils_1.switchClient)(2);
        yield (0, test_utils_1.synchronizerStart)();
    ...
    it('should not save revisions when an item_change has been generated as a result of a sync', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should handle case when new rev is created on client, then older rev arrives later via sync', (() => __awaiter(void 0, void 0, void 0, function* () {
        // - C1 creates note 1
    ...
    it('should not create revisions when item is modified as a result of decryption', (() => __awaiter(void 0, void 0, void 0, function* () {
