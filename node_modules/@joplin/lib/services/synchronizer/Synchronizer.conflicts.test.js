...
describe('Synchronizer.conflicts', () => {
    ...
    it('should resolve note conflicts', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should resolve folders conflicts', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    it('should resolve conflict if remote folder has been deleted, but note has been added to folder locally', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
        yield (0, test_utils_1.synchronizerStart)();
        yield (0, test_utils_1.switchClient)(2);
        yield (0, test_utils_1.synchronizerStart)();
    ...
    it('should resolve conflict if note has been deleted remotely and locally', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should handle conflict when remote note is deleted then local note is modified', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
        const note1 = yield Note_1.default.save({ title: 'un', parent_id: folder1.id });
        yield (0, test_utils_1.synchronizerStart)();
        yield (0, test_utils_1.switchClient)(2);
    ...
    it('should handle conflict when remote folder is deleted then local folder is renamed', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    it('should not sync notes with conflicts', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not try to delete on remote conflicted notes that have been deleted', (() => __awaiter(void 0, void 0, void 0, function* () {
        const f1 = yield Folder_1.default.save({ title: 'folder' });
    ...
    it('should not consider it is a conflict if neither the title nor body of the note have changed', (() => __awaiter(void 0, void 0, void 0, function* () {
        yield ignorableNoteConflictTest(false);
    })));
    it('should always handle conflict if local or remote are encrypted', (() => __awaiter(void 0, void 0, void 0, function* () {
