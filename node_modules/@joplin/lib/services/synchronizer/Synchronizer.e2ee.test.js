...
describe('Synchronizer.e2ee', () => {
    ...
    it('notes and folders should get encrypted when encryption is enabled', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should mark the key has having been used when synchronising the first time', (() => __awaiter(void 0, void 0, void 0, function* () {
        (0, syncInfoUtils_1.setEncryptionEnabled)(true);
    ...
    it('should mark the key has having been used when synchronising after enabling encryption', (() => __awaiter(void 0, void 0, void 0, function* () {
        yield Folder_1.default.save({ title: 'folder1' });
        yield (0, test_utils_1.synchronizerStart)();
        (0, syncInfoUtils_1.setEncryptionEnabled)(true);
        yield (0, test_utils_1.loadEncryptionMasterKey)();
    ...
    it('should enable encryption automatically when downloading new master key (and none was previously available)', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should encrypt existing notes too when enabling E2EE', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should upload decrypted items to sync target after encryption disabled', (() => __awaiter(void 0, void 0, void 0, function* () {
        (0, syncInfoUtils_1.setEncryptionEnabled)(true);
        yield (0, test_utils_1.loadEncryptionMasterKey)();
        yield Folder_1.default.save({ title: 'folder1' });
        yield (0, test_utils_1.synchronizerStart)();
    ...
    it('should not upload any item if encryption was enabled, and items have not been decrypted, and then encryption disabled', (() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const hasThrown = yield (0, test_utils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield (0, utils_1.setupAndDisableEncryption)((0, test_utils_1.encryptionService)()); }));
    ...
    it('should set the resource file size after decryption', (() => __awaiter(void 0, void 0, void 0, function* () {
        (0, syncInfoUtils_1.setEncryptionEnabled)(true);
        const masterKey = yield (0, test_utils_1.loadEncryptionMasterKey)();
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    it('should encrypt remote resources after encryption has been enabled', (() => __awaiter(void 0, void 0, void 0, function* () {
        while (insideBeforeEach)
            yield time_1.default.msleep(100);
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
        const note1 = yield Note_1.default.save({ title: 'ma note', parent_id: folder1.id });
    ...
    it('should upload encrypted resource, but it should not mark the blob as encrypted locally', (() => __awaiter(void 0, void 0, void 0, function* () {
        while (insideBeforeEach)
            yield time_1.default.msleep(100);
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
        const note1 = yield Note_1.default.save({ title: 'ma note', parent_id: folder1.id });
    ...
    it('should decrypt the resource metadata, but not try to decrypt the file, if it is not present', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should stop trying to decrypt item after a few attempts', (() => __awaiter(void 0, void 0, void 0, function* () {
        let hasThrown;
        ...
        Setting_1.default.setObjectValue('encryption.passwordCache', masterKey.id, '123456');
        yield (0, utils_1.loadMasterKeysFromSettings)((0, test_utils_1.encryptionService)());
        hasThrown = yield (0, test_utils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield (0, test_utils_1.decryptionWorker)().start({ errorHandler: 'throw' }); }));
        expect(hasThrown).toBe(true);
        hasThrown = yield (0, test_utils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield (0, test_utils_1.decryptionWorker)().start({ errorHandler: 'throw' }); }));
        expect(hasThrown).toBe(true);
