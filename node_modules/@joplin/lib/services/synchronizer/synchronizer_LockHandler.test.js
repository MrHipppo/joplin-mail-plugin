...
describe('synchronizer_LockHandler', () => {
    ...
    it('should acquire and release a sync lock', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not use files that are not locks', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should allow multiple sync locks', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should auto-refresh a lock', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should call the error handler when lock has expired while being auto-refreshed', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not allow sync locks if there is an exclusive lock', (() => __awaiter(void 0, void 0, void 0, function* () {
        yield lockHandler().acquireLock(LockHandler_1.LockType.Exclusive, LockHandler_1.LockClientType.Desktop, '111');
        yield (0, test_utils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () {
            yield lockHandler().acquireLock(LockHandler_1.LockType.Sync, LockHandler_1.LockClientType.Mobile, '222');
        }), 'hasExclusiveLock');
    })));
    it('should not allow exclusive lock if there are sync locks', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should allow exclusive lock if the sync locks have expired', (() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, test_utils_1.expectNotThrow)(() => __awaiter(void 0, void 0, void 0, function* () {
            yield lockHandler.acquireLock(LockHandler_1.LockType.Exclusive, LockHandler_1.LockClientType.Desktop, '333');
        }));
    })));
    it('should decide what is the active exclusive lock', (() => __awaiter(void 0, void 0, void 0, function* () {
