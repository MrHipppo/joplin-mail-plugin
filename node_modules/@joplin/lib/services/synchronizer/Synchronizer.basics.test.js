...
describe('Synchronizer.basics', () => {
    ...
    it('should create remote items', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should update remote items', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder = yield Folder_1.default.save({ title: 'folder1' });
    ...
    it('should create local items', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder = yield Folder_1.default.save({ title: 'folder1' });
        yield Note_1.default.save({ title: 'un', parent_id: folder.id });
        yield (0, test_utils_1.synchronizerStart)();
    ...
    it('should update local items', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should delete remote notes', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
        const note1 = yield Note_1.default.save({ title: 'un', parent_id: folder1.id });
        yield (0, test_utils_1.synchronizerStart)();
        yield (0, test_utils_1.switchClient)(2);
    ...
    it('should not created deleted_items entries for items deleted via sync', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    it('should delete local notes', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
        const note1 = yield Note_1.default.save({ title: 'un', parent_id: folder1.id });
    ...
    it('should delete remote folder', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should delete local folder', (() => __awaiter(void 0, void 0, void 0, function* () {
        yield Folder_1.default.save({ title: 'folder1' });
        const folder2 = yield Folder_1.default.save({ title: 'folder2' });
        yield (0, test_utils_1.synchronizerStart)();
        yield (0, test_utils_1.switchClient)(2);
    ...
    it('should cross delete all folders', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('items should be downloaded again when user cancels in the middle of delta operation', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    it('should skip items that cannot be synced', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    it('should handle items that are read-only on the sync target', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder = yield Folder_1.default.save({ title: 'folder' });
        const note = yield Note_1.default.save({ title: 'un', is_todo: 1, parent_id: folder.id });
        ...
        yield (0, test_utils_1.synchronizerStart)();
        (0, test_utils_1.synchronizer)().testingHooks_ = [];
        const noteReload = yield Note_1.default.load(note.id);
        expect(noteReload.title).toBe(note.title);
        const conflictNote = (yield Note_1.default.all()).find((n) => !!n.is_conflict);
        expect(conflictNote).toBeTruthy();
        expect(conflictNote.title).toBe('un mod');
        expect(conflictNote.id).not.toBe(note.id);
    })));
    it('should allow duplicate folder titles', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should create remote items with UTF-8 content', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should update remote items but not pull remote changes', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder = yield Folder_1.default.save({ title: 'folder1' });
        const note = yield Note_1.default.save({ title: 'un', parent_id: folder.id });
        yield (0, test_utils_1.synchronizerStart)();
        yield (0, test_utils_1.switchClient)(2);
    ...
    it('should create a new Welcome notebook on each client', (() => __awaiter(void 0, void 0, void 0, function* () {
        // Create the Welcome items on two separate clients
        yield WelcomeUtils_1.default.createWelcomeItems('en_GB');
        yield (0, test_utils_1.synchronizerStart)();
        yield (0, test_utils_1.switchClient)(2);
        yield WelcomeUtils_1.default.createWelcomeItems('en_GB');
    ...
    it('should not wipe out user data when syncing with an empty target', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not sync deletions that came via sync even when there is a conflict', (() => __awaiter(void 0, void 0, void 0, function* () {
