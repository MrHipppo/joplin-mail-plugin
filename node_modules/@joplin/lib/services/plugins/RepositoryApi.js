...
const findWorkingGitHubUrl = (defaultContentUrl) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const mirrorUrl of mirrorUrls) {
        try {
            ...
            yield shim_1.default.fetch(`${mirrorUrl}/.gitignore`);
        }
        catch (error) {
...
class RepositoryApi {
    ...
    initialize() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.contentBaseUrl_ = this.isLocalRepo ? defaultContentBaseUrl : yield findWorkingGitHubUrl(defaultContentBaseUrl);
    ...
    loadRelease() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.isLocalRepo)
                return;
            try {
                const response = yield shim_1.default.fetch(`${this.githubApiUrl}/releases`);
    ...
    canBeUpdatedPlugins(installedManifests, appVersion) {
        return __awaiter(this, void 0, void 0, function* () {
            const output = [];
            for (const manifest of installedManifests) {
                const canBe = yield this.pluginCanBeUpdated(manifest.id, manifest.version, appVersion);
                if (canBe)
    ...
    pluginCanBeUpdated(pluginId, installedVersion, appVersion) {
        return __awaiter(this, void 0, void 0, function* () {
            const manifest = (yield this.manifests()).find(m => m.id === pluginId);
            if (!manifest)
                return false;
            return (0, compare_versions_1.compareVersions)(installedVersion, manifest.version) < 0 && (0, compare_versions_1.compareVersions)(appVersion, manifest.app_min_version) >= 0;
        });
    }
}
