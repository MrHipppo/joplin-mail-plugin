...
class JoplinSettings {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            for (const [key, setting] of Object.entries(settings)) {
                ...
                if ('section' in setting)
                    internalSettingItem.section = (0, exports.namespacedKey)(this.plugin_.id, setting.section);
                ...
                yield Setting_1.default.registerSetting((0, exports.namespacedKey)(this.plugin_.id, key), internalSettingItem);
            }
        });
    }
    /**
    ...
    registerSection(name, section) {
        return __awaiter(this, void 0, void 0, function* () {
            return Setting_1.default.registerSection((0, exports.namespacedKey)(this.plugin_.id, name), Setting_1.SettingSectionSource.Plugin, section);
        });
    }
    /**
    ...
    value(key) {
        return __awaiter(this, void 0, void 0, function* () {
            return Setting_1.default.value((0, exports.namespacedKey)(this.plugin_.id, key));
        });
    }
    /**
    ...
    setValue(key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            return Setting_1.default.setValue((0, exports.namespacedKey)(this.plugin_.id, key), value);
        });
    }
    /**
