...
class ResourceEditWatcher {
    ...
    watchFile(fileToWatch) {
        ...
        if (!this.watcher_) {
            ...
            //
            this.watcher_.on('raw', (event, _path, options) => {
    ...
    makeEditPath(resource) {
        return __awaiter(this, void 0, void 0, function* () {
            const tempDir = yield this.tempDir();
            return (0, path_utils_1.toSystemSlashes)(yield shim_1.default.fsDriver().findUniqueFilename(`${tempDir}/${Resource_1.default.friendlySafeFilename(resource)}`), 'linux');
        });
    }
    copyResourceToEditablePath(resourceId) {
        return __awaiter(this, void 0, void 0, function* () {
            const resource = yield Resource_1.default.load(resourceId);
            ...
            const editFilePath = yield this.makeEditPath(resource);
    ...
    watch(resourceId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!watchedItem) {
                ...
                const { resource, editFilePath } = yield this.copyResourceToEditablePath(resourceId);
    ...
    // affected.
    openAsReadOnly(resourceId) {
        return __awaiter(this, void 0, void 0, function* () {
            const { editFilePath } = yield this.copyResourceToEditablePath(resourceId);
            yield shim_1.default.fsDriver().chmod(editFilePath, 0o0666);
