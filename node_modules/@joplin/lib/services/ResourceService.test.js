...
describe('services/ResourceService', () => {
    ...
    it('should delete orphaned resources', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not delete resource if still associated with at least one note', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = new ResourceService_1.default();
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
        let note1 = yield Note_1.default.save({ title: 'ma note', parent_id: folder1.id });
        ...
        yield Note_1.default.delete(note1.id);
        yield service.indexNoteResources();
        yield Note_1.default.save({ id: note2.id, body: Resource_1.default.markupTag(resource1) });
        yield service.indexNoteResources();
        yield service.deleteOrphanResources(0);
        expect(!!(yield Resource_1.default.load(resource1.id))).toBe(true);
    })));
    ...
    // }));
    it('should not delete resource if it is used in an IMG tag', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = new ResourceService_1.default();
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
        let note1 = yield Note_1.default.save({ title: 'ma note', parent_id: folder1.id });
        note1 = yield shim_1.default.attachFileToNote(note1, `${test_utils_1.supportDir}/photo.jpg`);
    ...
    it('should not process twice the same change', (() => __awaiter(void 0, void 0, void 0, function* () {
        const service = new ResourceService_1.default();
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    it('should not delete resources that are associated with an encrypted note', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should double-check if the resource is still linked before deleting it', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should delete a resource if it is not associated with any note and has never been synced', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should NOT delete a resource if it arrived via synced, even if it is not associated with any note', (() => __awaiter(void 0, void 0, void 0, function* () {
