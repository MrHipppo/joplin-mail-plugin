...
describe('ShareService', () => {
    ...
    it('should not change the note user timestamps when sharing or unsharing', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should share a folder', () => __awaiter(void 0, void 0, void 0, function* () {
        yield testShareFolder(testShareFolderService());
    }));
    it('should share a folder - E2EE', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should add a recipient', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const service = testShareFolderService({
            ...
            'GET api/users/toto%40example.com/public_key': (_query, _body) => __awaiter(void 0, void 0, void 0, function* () {
                return recipientPpk;
            }),
            'POST api/shares/share_1/users': (_query, body) => __awaiter(void 0, void 0, void 0, function* () {
                uploadedEmail = body.email;
                uploadedMasterKey = JSON.parse(body.master_key);
            }),
        });
        const { share } = yield testShareFolder(service);
        yield service.addShareRecipient(share.id, share.master_key_id, 'toto@example.com', { can_read: 1, can_write: 1 });
    ...
    it('should leave folders that are no longer with the user', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const service = testShareFolderService({
            'GET api/shares': (_query, _body) => __awaiter(void 0, void 0, void 0, function* () {
                return {
                    items: [],
                    has_more: false,
                };
    ...
    it('should leave a shared folder', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield Folder_1.default.save({ id: folder1.id, share_id: '123456789' });
        ...
        yield shareService.leaveSharedFolder(folder1.id, 'somethingrandom');
        expect(yield Folder_1.default.count()).toBe(0);
        expect(yield Note_1.default.count()).toBe(0);
        const deletedItems = yield BaseItem_1.default.deletedItems(Setting_1.default.value('sync.target'));
