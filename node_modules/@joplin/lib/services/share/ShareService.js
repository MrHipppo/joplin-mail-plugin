...
class ShareService {
    ...
    leaveSharedFolder(folderId, folderShareUserId = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Folder_1.default.updateAllShareIds(ResourceService_1.default.instance());
            yield Folder_1.default.delete(folderId, { deleteChildren: false, disableReadOnlyCheck: true });
            yield Folder_1.default.deleteAllByShareId(folder.share_id, { disableReadOnlyCheck: true, trackDeleted: false });
        });
    }
    ...
    addShareRecipient(shareId, masterKeyId, recipientEmail, permissions) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    setPermissions(shareId, shareUserId, permissions) {
        return __awaiter(this, void 0, void 0, function* () {
            logger.info('setPermissions: ', shareUserId, permissions);
            yield this.api().exec('PATCH', `api/share_users/${shareUserId}`, null, {
                can_read: 1,
