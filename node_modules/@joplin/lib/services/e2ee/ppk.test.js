...
describe('e2ee/ppk', () => {
    ...
    it('should create a public private key pair', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should create different key pairs every time', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should encrypt a master key using PPK', (() => __awaiter(void 0, void 0, void 0, function* () {
        const ppk = yield (0, ppk_1.generateKeyPair)((0, test_utils_1.encryptionService)(), '111111');
    ...
    it('should check if a PPK password is valid', (() => __awaiter(void 0, void 0, void 0, function* () {
        const ppk = yield (0, ppk_1.generateKeyPair)((0, test_utils_1.encryptionService)(), '111111');
        ...
        yield (0, test_utils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, ppk_1.ppkPasswordIsValid)((0, test_utils_1.encryptionService)(), null, '111111'); }));
    })));
    it('should transmit key using a public-private key', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should decrypt and encrypt data from different devices', (() => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, test_utils_1.expectNotThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, ppkTestUtils_1.runIntegrationTests)(true); }));
    })));
});
