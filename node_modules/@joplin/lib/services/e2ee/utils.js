...
function resetMasterPassword(encryptionService, kvStore, shareService, newPassword) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        Setting_1.default.setValue('encryption.masterPassword', newPassword);
        const masterKey = yield encryptionService.generateMasterKey(newPassword);
        yield MasterKey_1.default.save(masterKey);
        yield loadMasterKeysFromSettings(encryptionService);
    });
}
