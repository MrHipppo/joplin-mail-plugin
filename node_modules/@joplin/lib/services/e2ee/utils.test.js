...
describe('e2ee/utils', () => {
    ...
    it('should tell if the missing master key message should be shown', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect((0, utils_1.showMissingMasterKeyMessage)((0, syncInfoUtils_1.localSyncInfo)(), [mk1.id, mk2.id])).toBe(true);
        yield (0, test_utils_1.expectNotThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, utils_1.showMissingMasterKeyMessage)((0, syncInfoUtils_1.localSyncInfo)(), ['not_downloaded_yet']); }));
    ...
    it('should do the master password migration', () => __awaiter(void 0, void 0, void 0, function* () {
        const mk1 = yield MasterKey_1.default.save(yield (0, test_utils_1.encryptionService)().generateMasterKey('111111'));
    ...
    it('should update the master password', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, test_utils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, utils_1.updateMasterPassword)('wrong', masterPassword1); }));
    }));
    it('should set and verify master password when a data key exists', () => __awaiter(void 0, void 0, void 0, function* () {
        const password = '111111';
        yield MasterKey_1.default.save(yield (0, test_utils_1.encryptionService)().generateMasterKey(password));
        yield (0, test_utils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, utils_1.updateMasterPassword)('', 'wrong'); }));
        yield (0, test_utils_1.expectNotThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, utils_1.updateMasterPassword)('', password); }));
        expect(Setting_1.default.value('encryption.masterPassword')).toBe(password);
    }));
    it('should set and verify master password when a private key exists', () => __awaiter(void 0, void 0, void 0, function* () {
        const password = '111111';
    ...
    it('should only set the master password if not already set', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should change the master password even if no key is present', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, utils_1.updateMasterPassword)('', '111111');
        expect(Setting_1.default.value('encryption.masterPassword')).toBe('111111');
        yield (0, utils_1.updateMasterPassword)('111111', '222222');
        expect(Setting_1.default.value('encryption.masterPassword')).toBe('222222');
    }));
    it('should reset a master password', () => __awaiter(void 0, void 0, void 0, function* () {
        const masterPassword1 = '111111';
        const masterPassword2 = '222222';
        Setting_1.default.setValue('encryption.masterPassword', masterPassword1);
        const mk1 = yield MasterKey_1.default.save(yield (0, test_utils_1.encryptionService)().generateMasterKey(masterPassword1));
    ...
    it('should fix active key selection issues - 1', () => __awaiter(void 0, void 0, void 0, function* () {
        const masterPassword1 = '111111';
        Setting_1.default.setValue('encryption.masterPassword', masterPassword1);
        const mk1 = yield MasterKey_1.default.save(yield (0, test_utils_1.encryptionService)().generateMasterKey(masterPassword1));
        yield (0, test_utils_1.msleep)(1);
        yield MasterKey_1.default.save(yield (0, test_utils_1.encryptionService)().generateMasterKey(masterPassword1));
        yield (0, test_utils_1.msleep)(1);
        const mk3 = yield MasterKey_1.default.save(yield (0, test_utils_1.encryptionService)().generateMasterKey(masterPassword1));
        (0, syncInfoUtils_1.setActiveMasterKeyId)(mk1.id);
        (0, syncInfoUtils_1.setMasterKeyEnabled)(mk1.id, false);
    ...
    it('should fix active key selection issues - 2', () => __awaiter(void 0, void 0, void 0, function* () {
