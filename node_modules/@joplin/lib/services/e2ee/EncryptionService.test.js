...
describe('services_EncryptionService', () => {
    ...
    it('should encode and decode header', (() => __awaiter(void 0, void 0, void 0, function* () {
        const header = {
    ...
    it('should generate and decrypt a master key', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should upgrade a master key', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not upgrade master key if invalid password', (() => __awaiter(void 0, void 0, void 0, function* () {
        const masterKey = yield service.generateMasterKey('123456', {
            encryptionMethod: EncryptionService_1.EncryptionMethod.SJCL2,
        });
        yield (0, test_utils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield service.reencryptMasterKey(masterKey, '777', '777'); }));
    })));
    it('should require a checksum only for old master keys', (() => __awaiter(void 0, void 0, void 0, function* () {
        const masterKey = yield service.generateMasterKey('123456', {
            encryptionMethod: EncryptionService_1.EncryptionMethod.SJCL2,
        });
    ...
    it('should not require a checksum for new master keys', (() => __awaiter(void 0, void 0, void 0, function* () {
        const masterKey = yield service.generateMasterKey('123456', {
    ...
    it('should throw an error if master key decryption fails', (() => __awaiter(void 0, void 0, void 0, function* () {
        const masterKey = yield service.generateMasterKey('123456', {
            encryptionMethod: EncryptionService_1.EncryptionMethod.SJCL4,
        });
        const hasThrown = yield (0, test_utils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield service.decryptMasterKeyContent(masterKey, 'wrong'); }));
        expect(hasThrown).toBe(true);
    })));
    it('should return the master keys that need an upgrade', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should encrypt and decrypt with a master key', (() => __awaiter(void 0, void 0, void 0, function* () {
        let masterKey = yield service.generateMasterKey('123456');
        masterKey = yield MasterKey_1.default.save(masterKey);
        yield service.loadMasterKey(masterKey, '123456', true);
        const cipherText = yield service.encryptString('some secret');
    ...
    it('should decrypt various encryption methods', (() => __awaiter(void 0, void 0, void 0, function* () {
        let masterKey = yield service.generateMasterKey('123456');
        masterKey = yield MasterKey_1.default.save(masterKey);
        yield service.loadMasterKey(masterKey, '123456', true);
        {
    ...
    it('should fail to decrypt if master key not present', (() => __awaiter(void 0, void 0, void 0, function* () {
        let masterKey = yield service.generateMasterKey('123456');
        masterKey = yield MasterKey_1.default.save(masterKey);
        yield service.loadMasterKey(masterKey, '123456', true);
        const cipherText = yield service.encryptString('some secret');
        yield service.unloadMasterKey(masterKey);
        const hasThrown = yield (0, test_utils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield service.decryptString(cipherText); }));
        expect(hasThrown).toBe(true);
    })));
    it('should fail to decrypt if data tampered with', (() => __awaiter(void 0, void 0, void 0, function* () {
        let masterKey = yield service.generateMasterKey('123456');
        masterKey = yield MasterKey_1.default.save(masterKey);
        yield service.loadMasterKey(masterKey, '123456', true);
    ...
    it('should encrypt and decrypt notes and folders', (() => __awaiter(void 0, void 0, void 0, function* () {
        let masterKey = yield service.generateMasterKey('123456');
        masterKey = yield MasterKey_1.default.save(masterKey);
        yield service.loadMasterKey(masterKey, '123456', true);
    ...
    it('should encrypt and decrypt files', (() => __awaiter(void 0, void 0, void 0, function* () {
        let masterKey = yield service.generateMasterKey('123456');
        masterKey = yield MasterKey_1.default.save(masterKey);
        yield service.loadMasterKey(masterKey, '123456', true);
    ...
    it('should encrypt invalid UTF-8 data', (() => __awaiter(void 0, void 0, void 0, function* () {
        let masterKey = yield service.generateMasterKey('123456');
        masterKey = yield MasterKey_1.default.save(masterKey);
        yield service.loadMasterKey(masterKey, '123456', true);
        ...
        const hasThrown = yield (0, test_utils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield service.encryptString('🐶🐶🐶'.substr(0, 5)); }));
        expect(hasThrown).toBe(true);
    ...
    it('should check if a master key is loaded', (() => __awaiter(void 0, void 0, void 0, function* () {
        let masterKey = yield service.generateMasterKey('123456');
        masterKey = yield MasterKey_1.default.save(masterKey);
        yield service.loadMasterKey(masterKey, '123456', true);
