...
class BaseApplication {
    ...
    handleStartFlags_(argv, setDefaults = true) {
        return __awaiter(this, void 0, void 0, function* () {
            const flags = yield (0, processStartFlags_1.default)(argv, setDefaults);
            ...
            const sideEffects = {
                ...
                'syncInfoCache': () => __awaiter(this, void 0, void 0, function* () {
                    if (this.hasGui()) {
                        ...
                        yield (0, utils_2.loadMasterKeysFromSettings)(EncryptionService_1.default.instance());
                        void DecryptionWorker_1.default.instance().scheduleStart();
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.hasGui() && ['NOTE_UPDATE_ONE', 'NOTE_DELETE', 'FOLDER_UPDATE_ONE', 'FOLDER_DELETE'].indexOf(action.type) >= 0) {
                if (!(yield registry_1.reg.syncTarget().syncStarted()))
                    void registry_1.reg.scheduleSync(15 * 1000, { syncSteps: ['update_remote', 'delete_remote'] });
    ...
    static determineProfileDir(initArgs) {
        let output = '';
    ...
    startRotatingLogMaintenance(profileDir) {
        ...
        const processLogs = () => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.rotatingLogs.cleanActiveLogFile();
                yield this.rotatingLogs.deleteNonActiveLogFiles();
            }
            catch (error) {
    ...
    start(argv, options = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, utils_2.migrateMasterPassword)();
            yield (0, handleSyncStartupOperation_1.default)();
            appLogger.info(`Client ID: ${Setting_1.default.value('clientId')}`);
            BaseItem_1.default.syncShareCache = (0, reducer_2.parseShareCache)(Setting_1.default.value('sync.shareCache'));
            ...
            if ((yield fs.pathExists(safeModeFlagFile)) && fs.readFileSync(safeModeFlagFile, 'utf8') === 'true') {
