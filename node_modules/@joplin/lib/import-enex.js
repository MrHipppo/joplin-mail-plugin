    ...
    return __awaiter(this, void 0, void 0, function* () {
        if (!resource.hasData) {
            ...
            if (!resource.id) {
                ...
                resource.id = yield md5File(resource.dataFilePath);
            }
...
function saveNoteResources(note) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < note.resources.length; i++) {
            ...
            toSave.file_extension = resource.filename ? (0, path_utils_1.fileExtension)(resource.filename) : '';
...
function saveNoteToStorage(note, importOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        importOptions = Object.assign({ fuzzyMatching: false }, importOptions);
                    ...
                    while (notes.length) {
                        ...
                        try {
                            ...
                            const body = importOptions.outputFormat === 'html' ?
                                ...
                                yield (0, import_enex_md_gen_1.enexXmlToMd)(note.bodyXml, note.resources, note.tasks);
                            delete note.bodyXml;
