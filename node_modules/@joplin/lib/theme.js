...
exports.buildStyle = exports.themeStyle = exports.addExtraStyles = exports.themeById = void 0;
...
function addExtraStyles(style) {
    ...
    style = Object.assign(Object.assign({}, fontSizes), style);
    ...
    style.icon = Object.assign(Object.assign({}, style.icon), { color: style.color });
    style.lineInput = Object.assign(Object.assign({}, style.lineInput), { color: style.color, backgroundColor: style.backgroundColor });
    style.headerStyle = Object.assign(Object.assign({}, style.headerStyle), { color: style.color, backgroundColor: style.backgroundColor });
    style.inputStyle = Object.assign(Object.assign({}, style.inputStyle), { color: style.color, backgroundColor: style.backgroundColor, borderColor: style.dividerColor });
    style.containerStyle = Object.assign(Object.assign({}, style.containerStyle), { color: style.color, backgroundColor: style.backgroundColor });
    style.buttonStyle = Object.assign(Object.assign({}, style.buttonStyle), { color: style.color4, backgroundColor: style.backgroundColor4, borderColor: style.borderColor4, userSelect: 'none' });
    style.tagStyle = {
    ...
    style.clickableTextStyle = Object.assign(Object.assign({}, style.textStyle), { userSelect: 'none' });
    style.textStyle2 = Object.assign(Object.assign({}, style.textStyle), { color: style.color2 });
    style.textStyleMinor = Object.assign(Object.assign({}, style.textStyle), { color: style.colorFaded, fontSize: style.fontSize * 0.8 });
    style.urlStyle = Object.assign(Object.assign({}, style.textStyle), { textDecoration: 'underline', color: style.urlColor });
    style.h1Style = Object.assign(Object.assign({}, style.textStyle), { color: style.color, fontSize: style.textStyle.fontSize * 1.5, fontWeight: 'bold' });
    style.h2Style = Object.assign(Object.assign({}, style.textStyle), { color: style.color, fontSize: style.textStyle.fontSize * 1.3, fontWeight: 'bold' });
    ...
    style.dialogTitle = Object.assign(Object.assign({}, style.h1Style), { marginBottom: '1.2em' });
...
exports.addExtraStyles = addExtraStyles;
const themeCache_ = {};
function themeStyle(themeId) {
    ...
    // relevant properties
    output = Object.assign(Object.assign({}, globalStyle), themes[themeId]);
