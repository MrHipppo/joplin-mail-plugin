...
class TestApp extends BaseApplication_1.default {
    ...
    start(argv) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            argv = yield _super.start.call(this, ['', ''].concat(argv), { setupGlobalLogger: false });
...
const simulateReadOnlyShareEnv = (shareId) => {
    Setting_1.default.setValue('sync.target', 10);
    Setting_1.default.setValue('sync.userId', 'abcd');
    BaseItem_1.default.syncShareCache = createTestShareData(shareId);
    return () => {
