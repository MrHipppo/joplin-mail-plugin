        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                try {
                    ...
                    eventManager_1.default.emit('sessionEstablished');
                ...
                if (syncSteps.indexOf('delete_remote') >= 0) {
                    yield (0, syncDeleteStep_1.default)(syncTargetId, this.cancelling(), (action, local, logSyncOperation, message, actionCount) => {
                ...
                if (syncSteps.indexOf('update_remote') >= 0) {
                    ...
                    while (true) {
                        ...
                        for (let i = 0; i < locals.length; i++) {
                            ...
                            if (local.type_ === BaseModel_1.default.TYPE_RESOURCE && (action === 'createRemote' || action === 'updateRemote')) {
                                ...
                                if (localState.fetch_status !== Resource_1.default.FETCH_STATUS_DONE) {
                                    ...
                                    try {
                                        ...
                                        const syncItem = yield BaseItem_1.default.syncItem(syncTargetId, resource.id, { fields: ['sync_time', 'force_sync'] });
                            ...
                            yield (0, handleConflictAction_1.default)(action, ItemClass, !!remote, remoteContent, local, syncTargetId, itemIsReadOnly, (action) => this.dispatch(action));
                            completeItemProcessing(path);
                        }
                        if (!result.hasMore)
                            break;
