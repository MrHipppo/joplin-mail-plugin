...
class Setting extends BaseModel_1.default {
    ...
    static metadata() {
        ...
        this.buildInMetadata_ = {
            ...
            'security.biometricsEnabled': {
                value: false,
                type: SettingItemType.Bool,
                label: () => `${(0, locale_1._)('Use biometrics to secure access to the app')} (Beta)`,
    ...
    static sectionMetadataToSummary(metadata) {
        ...
        const sectionNameToSummary = {
            ...
            'export': (0, locale_1._)('Export your data'),
            'moreInfo': (0, locale_1._)('Donate, website'),
        };
        return (_a = sectionNameToSummary[metadata.name]) !== null && _a !== void 0 ? _a : '';
    }
