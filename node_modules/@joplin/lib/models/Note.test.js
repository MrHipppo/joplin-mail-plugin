...
describe('models/Note', () => {
    ...
    it('should find resource and note IDs', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should find linked items', (() => __awaiter(void 0, void 0, void 0, function* () {
        const testCases = [
    ...
    it('should change the type of notes', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    it('should serialize and unserialize without modifying data', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
        const testCases = [
    ...
    it('should reset fields for a duplicate', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    it('should duplicate a note with tags', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    it('should also duplicate resources when duplicating a note', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should delete a set of notes', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'folder1' });
        const noOfNotes = 20;
    ...
    it('should delete only the selected notes', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should delete nothing', (() => __awaiter(void 0, void 0, void 0, function* () {
        const f1 = yield Folder_1.default.save({ title: 'folder1' });
        const f2 = yield Folder_1.default.save({ title: 'folder2', parent_id: f1.id });
    ...
    it('should not move to conflict folder', (() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const note1 = yield Note_1.default.save({ title: 'note', parent_id: folder1.id });
        const hasThrown = yield (0, test_utils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield Folder_1.default.moveToFolder(note1.id, folder2.id); }));
        expect(hasThrown).toBe(true);
        const note = yield Note_1.default.load(note1.id);
        expect(note.parent_id).toEqual(folder1.id);
    })));
    it('should not copy to conflict folder', (() => __awaiter(void 0, void 0, void 0, function* () {
        const folder1 = yield Folder_1.default.save({ title: 'Folder' });
        const folder2 = yield Folder_1.default.save({ title: Folder_1.default.conflictFolderTitle(), id: Folder_1.default.conflictFolderId() });
        const note1 = yield Note_1.default.save({ title: 'note', parent_id: folder1.id });
        const hasThrown = yield (0, test_utils_1.checkThrowAsync)(() => __awaiter(void 0, void 0, void 0, function* () { return yield Note_1.default.copyToFolder(note1.id, folder2.id); }));
        expect(hasThrown).toBe(true);
    })));
    it('should convert resource paths from internal to external paths', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should perform natural sorting', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should create a conflict note', () => __awaiter(void 0, void 0, void 0, function* () {
        const folder = yield Folder_1.default.save({ title: 'Source Folder' });
        const origNote = yield Note_1.default.save({ title: 'note', parent_id: folder.id, share_id: 'SHARE', is_shared: 1 });
    ...
    it('should copy conflicted note to target folder and cancel conflict', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should move conflicted note to target folder and cancel conflict', (() => __awaiter(void 0, void 0, void 0, function* () {
        const srcFolder = yield Folder_1.default.save({ title: 'Source Folder' });
        const targetFolder = yield Folder_1.default.save({ title: 'Target Folder' });
        const note1 = yield Note_1.default.save({ title: 'note', parent_id: srcFolder.id });
        const conflictedNote = yield Note_1.default.createConflictNote(note1, ItemChange_1.default.SOURCE_SYNC);
    ...
    it('should not allow modifying a read-only note', () => __awaiter(void 0, void 0, void 0, function* () {
        const folder = yield Folder_1.default.save({});
        const note = yield Note_1.default.save({ parent_id: folder.id });
        const cleanup = (0, test_utils_1.simulateReadOnlyShareEnv)('123456789');
        yield (0, test_utils_1.expectNotThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return yield Note_1.default.save({ id: note.id, title: 'can do this' }); }));
        yield Folder_1.default.save({ id: folder.id, share_id: '123456789' });
        yield Note_1.default.save({ id: note.id, share_id: '123456789' });
        yield (0, test_utils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return yield Note_1.default.save({ id: note.id, title: 'cannot do this!' }); }), errors_1.ErrorCode.IsReadOnly);
        yield (0, test_utils_1.expectNotThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return yield Note_1.default.save({ id: note.id, title: 'But it can be updated via sync' }, { changeSource: ItemChange_1.default.SOURCE_SYNC }); }));
        cleanup();
    }));
    it('should not allow deleting a read-only note', () => __awaiter(void 0, void 0, void 0, function* () {
        const folder = yield Folder_1.default.save({});
        const note1 = yield Note_1.default.save({ parent_id: folder.id });
        const cleanup = (0, test_utils_1.simulateReadOnlyShareEnv)('123456789');
        yield Folder_1.default.save({ id: folder.id, share_id: '123456789' });
        yield Note_1.default.save({ id: note1.id, share_id: '123456789' });
        yield (0, test_utils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return yield Note_1.default.delete(note1.id); }), errors_1.ErrorCode.IsReadOnly);
        cleanup();
    }));
    it('should not allow creating a new note as a child of a read-only folder', (() => __awaiter(void 0, void 0, void 0, function* () {
        const cleanup = (0, test_utils_1.simulateReadOnlyShareEnv)('123456789');
        const readonlyFolder = yield Folder_1.default.save({ share_id: '123456789' });
        yield (0, test_utils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return Note_1.default.save({ parent_id: readonlyFolder.id }); }), errors_1.ErrorCode.IsReadOnly);
        cleanup();
    })));
    it('should not allow adding an existing note as a child of a read-only folder', (() => __awaiter(void 0, void 0, void 0, function* () {
        const cleanup = (0, test_utils_1.simulateReadOnlyShareEnv)('123456789');
        const readonlyFolder = yield Folder_1.default.save({ share_id: '123456789' });
        const note = yield Note_1.default.save({});
        yield (0, test_utils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return Note_1.default.save({ id: note.id, parent_id: readonlyFolder.id }); }), errors_1.ErrorCode.IsReadOnly);
        cleanup();
    })));
});
