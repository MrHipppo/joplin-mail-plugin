...
describe('models/Revision', () => {
    ...
    it('should create patches of text and apply it', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should check if it is an empty revision', () => __awaiter(void 0, void 0, void 0, function* () {
        const testCases = [
            [false, {
                    title_diff: '',
                    body_diff: '',
    ...
    it('should not fail to create revisions on naughty strings', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should successfully handle legacy patches', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should create patches of objects and apply it', (() => __awaiter(void 0, void 0, void 0, function* () {
        const oldObject = {
            one: '123',
            two: '456',
            three: '789',
    ...
    it('should handle invalid object patch', (() => __awaiter(void 0, void 0, void 0, function* () {
        const oldObject = {
            one: '123',
            two: '456',
            three: '789',
...
"},"deleted":["one"]}`;
    ...
    it('should not strip off newlines from object values', (() => __awaiter(void 0, void 0, void 0, function* () {
        const oldObject = {
            one: '123',
            two: '456',
            three: '789',
    ...
    it('should move target revision to the top', (() => __awaiter(void 0, void 0, void 0, function* () {
        const revs = [
            { id: '123' },
            { id: '456' },
            { id: '789' },
    ...
    it('should create patch stats', (() => __awaiter(void 0, void 0, void 0, function* () {
        const tests = [
            {
                patch: `@@ -625,16 +625,48 @@
 rrupted download
