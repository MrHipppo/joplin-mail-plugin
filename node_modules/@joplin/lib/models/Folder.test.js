...
describe('models/Folder', () => {
    ...
    it('should tell if a folder can be nested under another one', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should recursively delete notes and sub-folders', (() => __awaiter(void 0, void 0, void 0, function* () {
        const f1 = yield Folder_1.default.save({ title: 'folder1' });
        const f2 = yield Folder_1.default.save({ title: 'folder2', parent_id: f1.id });
        const f3 = yield Folder_1.default.save({ title: 'folder3', parent_id: f2.id });
    ...
    it('should sort by last modified, based on content', (() => __awaiter(void 0, void 0, void 0, function* () {
        let folders;
        const f1 = yield Folder_1.default.save({ title: 'folder1' });
    ...
    it('should sort by last modified, based on content (sub-folders too)', (() => __awaiter(void 0, void 0, void 0, function* () {
        let folders;
        const f1 = yield Folder_1.default.save({ title: 'folder1' });
        yield (0, test_utils_1.sleep)(0.1);
        const f2 = yield Folder_1.default.save({ title: 'folder2' });
    ...
    it('should add node counts', (() => __awaiter(void 0, void 0, void 0, function* () {
        const f1 = yield Folder_1.default.save({ title: 'folder1' });
        const f2 = yield Folder_1.default.save({ title: 'folder2', parent_id: f1.id });
        const f3 = yield Folder_1.default.save({ title: 'folder3', parent_id: f2.id });
        const f4 = yield Folder_1.default.save({ title: 'folder4' });
    ...
    it('should not count completed to-dos', (() => __awaiter(void 0, void 0, void 0, function* () {
        const f1 = yield Folder_1.default.save({ title: 'folder1' });
        const f2 = yield Folder_1.default.save({ title: 'folder2', parent_id: f1.id });
        const f3 = yield Folder_1.default.save({ title: 'folder3', parent_id: f2.id });
        const f4 = yield Folder_1.default.save({ title: 'folder4' });
    ...
    it('should recursively find folder path', (() => __awaiter(void 0, void 0, void 0, function* () {
        const f1 = yield Folder_1.default.save({ title: 'folder1' });
        const f2 = yield Folder_1.default.save({ title: 'folder2', parent_id: f1.id });
        const f3 = yield Folder_1.default.save({ title: 'folder3', parent_id: f2.id });
        const folders = yield Folder_1.default.all();
    ...
    it('should sort folders alphabetically', (() => __awaiter(void 0, void 0, void 0, function* () {
        const f1 = yield Folder_1.default.save({ title: 'folder1' });
        const f2 = yield Folder_1.default.save({ title: 'folder2', parent_id: f1.id });
        const f3 = yield Folder_1.default.save({ title: 'folder3', parent_id: f1.id });
        const f4 = yield Folder_1.default.save({ title: 'folder4' });
    ...
    it('should not allow setting a folder parent as itself', (() => __awaiter(void 0, void 0, void 0, function* () {
        const f1 = yield Folder_1.default.save({ title: 'folder1' });
        const hasThrown = yield (0, test_utils_1.checkThrowAsync)(() => Folder_1.default.save({ id: f1.id, parent_id: f1.id }, { userSideValidation: true }));
        expect(hasThrown).toBe(true);
    })));
    it('should get all the children of a folder', (() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        {
            const children = yield Folder_1.default.allChildrenFolders(folder.id);
            expect(children.map(c => c.id).sort()).toEqual([folder2.id, folder3.id].sort());
        }
        {
            const children = yield Folder_1.default.allChildrenFolders(folder4.id);
            expect(children.map(c => c.id).sort()).toEqual([folder5.id].sort());
        }
        {
            const children = yield Folder_1.default.allChildrenFolders(folder5.id);
            expect(children.map(c => c.id).sort()).toEqual([].sort());
        }
    })));
    it('should not allow creating a new folder as a child of a read-only folder', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, test_utils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return Folder_1.default.save({ parent_id: readonlyFolder.id }); }), errors_1.ErrorCode.IsReadOnly);
        cleanup();
    }));
    it('should not allow moving a folder as a child of a read-only folder', () => __awaiter(void 0, void 0, void 0, function* () {
        const cleanup = (0, test_utils_1.simulateReadOnlyShareEnv)('123456789');
        const readonlyFolder = yield Folder_1.default.save({ share_id: '123456789' });
        const folder = yield Folder_1.default.save({});
        yield (0, test_utils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return Folder_1.default.save({ id: folder.id, parent_id: readonlyFolder.id }); }), errors_1.ErrorCode.IsReadOnly);
        cleanup();
    }));
    it('should not allow modifying a read-only folder', () => __awaiter(void 0, void 0, void 0, function* () {
        const cleanup = (0, test_utils_1.simulateReadOnlyShareEnv)('123456789');
        const readonlyFolder = yield Folder_1.default.save({ share_id: '123456789' });
        yield (0, test_utils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return Folder_1.default.save({ id: readonlyFolder.id, title: 'cannot do that' }); }), errors_1.ErrorCode.IsReadOnly);
        cleanup();
    }));
    it('should not allow deleting a read-only folder', () => __awaiter(void 0, void 0, void 0, function* () {
        const cleanup = (0, test_utils_1.simulateReadOnlyShareEnv)('123456789');
        const readonlyFolder = yield Folder_1.default.save({ share_id: '123456789' });
        yield (0, test_utils_1.expectThrow)(() => __awaiter(void 0, void 0, void 0, function* () { return Folder_1.default.delete(readonlyFolder.id); }), errors_1.ErrorCode.IsReadOnly);
        cleanup();
    }));
});
