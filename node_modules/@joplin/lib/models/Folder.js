...
class Folder extends BaseItem_1.default {
    ...
    static deleteAllByShareId(shareId, deleteOptions = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const tableName of ['folders', 'notes', 'resources']) {
                ...
                const rows = yield this.db().selectAll(`SELECT id FROM ${tableName} WHERE share_id = ?`, [shareId]);
                const ids = rows.map(r => r.id);
                yield ItemClass.batchDelete(ids, deleteOptions);
            }
        });
    }
    static delete(folderId, options = null) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (options.deleteChildren) {
                ...
                yield Note_1.default.batchDelete(noteIds, childrenDeleteOptions);
                const subFolderIds = yield Folder.subFolderIds(folderId);
                for (let i = 0; i < subFolderIds.length; i++) {
                    yield Folder.delete(subFolderIds[i], childrenDeleteOptions);
                }
            }
    ...
    static save(o, options = null) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let savedFolder = yield _super.save.call(this, o, options);
            ...
            if (!('share_id' in savedFolder) || !('parent_id' in savedFolder)) {
                savedFolder = yield this.load(savedFolder.id);
            }
            this.dispatch({
