...
class BaseItem extends BaseModel_1.default {
    ...
    static syncItem(syncTarget, itemId, options = null) {
        return __awaiter(this, void 0, void 0, function* () {
            options = Object.assign({ fields: '*' }, options);
            return yield this.db().selectOne(`SELECT ${this.db().escapeFieldsToString(options.fields)} FROM sync_items WHERE sync_target = ? AND item_id = ?`, [syncTarget, itemId]);
        });
    }
    ...
    static loadItemById(id, options = null) {
        return __awaiter(this, void 0, void 0, function* () {
            const classes = this.syncItemClassNames();
            for (let i = 0; i < classes.length; i++) {
                const item = yield this.getClass(classes[i]).load(id, options);
                if (item)
                    return item;
            }
            return null;
    ...
    static loadItemsByTypeAndIds(itemType, ids, options = null) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!ids.length)
                return [];
    ...
    static loadItemByTypeAndId(itemType, id, options = null) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.loadItemsByTypeAndIds(itemType, [id], options);
    ...
    static batchDelete(ids, options = null) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, readOnly_1.needsReadOnlyChecks)(this.modelType(), options.changeSource, this.syncShareCache, options.disableReadOnlyCheck)) {
                const previousItems = yield this.loadItemsByTypeAndIds(this.modelType(), ids, { fields: ['share_id', 'id'] });
    ...
    static save(o, options = null) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, readOnly_1.needsReadOnlyChecks)(this.modelType(), options.changeSource, this.syncShareCache)) {
                if (!isNew) {
                    const previousItem = yield this.loadItemByTypeAndId(this.modelType(), o.id, { fields: ['id', 'share_id'] });
                ...
                if (o.parent_id) {
                    yield (0, readOnly_1.checkIfItemCanBeAddedToFolder)(this.modelType(), this.getClass('Folder'), options.changeSource, BaseItem.syncShareCache, o.parent_id);
                }
            }
