...
class Note extends BaseItem_1.default {
    ...
    static insertNotesAt(folderId, noteIds, index, uncompletedTodosOnTop, showCompletedTodos) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!noteIds.length)
                return;
            const defer = () => {
            ...
            try {
                const getSortedNotes = (folderId) => __awaiter(this, void 0, void 0, function* () {
                    const noteSql = `
					...
					AND parent_id = ?
				`;
                    const notes_raw = yield this.modelSelectAll(noteSql, [folderId]);
                    return yield this.sortNotes(notes_raw, this.customOrderByColumns(), uncompletedTodosOnTop);
                });
                let notes = yield getSortedNotes(folderId);
                ...
                for (let i = 0; i < notes.length; i++) {
                    ...
                    if (!note.order) {
                        ...
                        const updatedNote = yield this.updateNoteOrder_(note, newOrder);
                        notes[i] = updatedNote;
                        hasSetOrder = true;
                    }
                ...
                if (hasSetOrder)
                    notes = yield getSortedNotes(folderId);
