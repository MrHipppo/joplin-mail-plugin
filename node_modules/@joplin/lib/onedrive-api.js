        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < 5; i++) {
                ...
                if (!response.ok) {
                    ...
                    if (error.code === 'InvalidAuthenticationToken' || error.code === 'unauthenticated') {
                    ...
                    else if ((error === null || error === void 0 ? void 0 : error.code) === 'activityLimitReached') {
                        ...
                        i--;
                        const retryAfter = (_c = (_b = (_a = response.headers) === null || _a === void 0 ? void 0 : _a.get) === null || _b === void 0 ? void 0 : _b.call(_a, 'retry-after')) !== null && _c !== void 0 ? _c : '1';
                        ...
                        yield handleRequestRepeat(error, sleepSeconds);
                        continue;
                    }
