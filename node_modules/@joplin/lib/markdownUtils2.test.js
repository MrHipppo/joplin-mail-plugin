...
describe('markdownUtils', () => {
    it('should prepend a base URL', (() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should extract image URLs', (() => __awaiter(void 0, void 0, void 0, function* () {
        const testCases = [
    ...
    it('should extract files URLs', (() => __awaiter(void 0, void 0, void 0, function* () {
        const testCases = [
            ['[something](http://test.com/img.png)', ['http://test.com/img.png']],
    ...
    it('escape a markdown link', (() => __awaiter(void 0, void 0, void 0, function* () {
        const testCases = [
    ...
    it('escape a markdown link (title)', (() => __awaiter(void 0, void 0, void 0, function* () {
        const testCases = [
    ...
    it('replace markdown link with description', (() => __awaiter(void 0, void 0, void 0, function* () {
        const testCases = [
